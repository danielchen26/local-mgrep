...
| [`local-mgrep-0.8.0.md`](local-mgrep-0.8.0.md) | Release notes for 0.8.0: end-to-end Claude Code agent benchmark (mgrep on/off across 6 questions × 3 languages). Headline: **−54 % agent tool calls** with mgrep, +1 task in answer correctness, equal token cost. |
